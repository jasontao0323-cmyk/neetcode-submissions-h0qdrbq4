...
#         self.left = left
#         self.right = right
# Brute force BST validation checks all nodes in left and right subtrees for each node, ensuring values are strictly less and greater, respectively. 
# This method is correct but inefficient due to redundant checks.
# TC: O(n^2)
# SC: O(n)
