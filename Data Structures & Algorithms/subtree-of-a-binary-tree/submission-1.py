...
#         self.left = left
#         self.right = right
# To determine if one tree is a subtree of another, traverse the main tree using DFS. At each node, compare 
# the subtree with the subRoot; if identical, the subRoot is a subtree.
# TC: O(m*n)
# SC: O(m+n)
